...
(() => {
  ...
  // Функция для логирования сообщений как в интерфейсе, так и в консоли
  ...
  // Анимация цветового цикла для Siri Ball
  ...
  function createWaves() {
    try {
      waveContainer.innerHTML = ""; // очищаем контейнер
  ...
  // Инициализация Web Audio API и запуск анализа звука
  ...
  // Обновление статуса с эффектом плавного появления
  ...
  // Инициализация обработчиков кнопок записи
